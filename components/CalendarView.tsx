...
const CalendarView: React.FC<CalendarViewProps> = ({ tasks, onEditTask }) => {
  ...
  let day = startDate;
  // Safety check to prevent infinite loop if math is wrong, though logic is standard
  // Comparing timestamps is safer for loop condition
  ...
  const getTasksForDate = (date: Date) => {
    const dayTasks = tasks.filter(task => {
      ...
      // Use parseDateString to ensure local time comparison
